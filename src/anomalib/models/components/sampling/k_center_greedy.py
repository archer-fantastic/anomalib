...
class KCenterGreedy:
    ...
    def update_distances(self, cluster_center: int | torch.Tensor | None) -> None:
        ...
        if cluster_center is not None:
            ...
            # Using torch.cdist avoids broadcasting self.features - center
            # which saves massive amounts of CPU memory and prevents OOM.
            center_2d = center.unsqueeze(0)
            distances = torch.cdist(self.features, center_2d, p=2.0)
